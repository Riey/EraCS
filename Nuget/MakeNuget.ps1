$CoreVersion = "1.3.0.0"
$FrontEndWpfVersion = "1.3.0.0"
$EraConsoleVersion = "1.4.0.0"
...
copy ..\EraCS.Core\bin\Release\Riey.EraCS.Core.1.3.0.nupkg .
copy ..\EraCS.UI.EraConsole\bin\Release\Riey.EraCS.UI.EraConsole.1.4.0.nupkg .
